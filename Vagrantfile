Vagrant.configure("2") do |config|
  ...
  config.vm.define "dz3_jenkins" do |build|
	...
	build.vm.network "private_network", ip: "192.168.56.110"
  ...
  config.vm.define "dz3_nexus" do |nexus|
    ...
    nexus.vm.network "private_network", ip: "192.168.56.101"
  ...
  config.vm.define "dz3_vproapp" do |vproapp|
    ...
    vproapp.vm.network "private_network", ip: "192.168.56.102"
